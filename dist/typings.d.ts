 ...
 */
export interface CustomBarItemData<TData extends CustomData = CustomData> {
	/**
...
export interface IChartApi {
	 ...
	 * ```
	 */
	addCustomSeries<TData extends CustomData, TOptions extends CustomSeriesOptions, TPartialOptions extends SeriesPartialOptions<TOptions> = SeriesPartialOptions<TOptions>>(customPaneView: ICustomSeriesPaneView<TData, TOptions>, customOptions?: SeriesPartialOptions<TOptions>): ISeriesApi<"Custom", TData | WhitespaceData, TOptions, TPartialOptions>;
	/**
 ...
 */
export interface ICustomSeriesPaneView<TData extends CustomData = CustomData, TSeriesOptions extends CustomSeriesOptions = CustomSeriesOptions> {
	/**
	 ...
	 */
	update(data: PaneRendererCustomData<TData>, seriesOptions: TSeriesOptions): void;
	/**
 ...
 */
export interface ISeriesApi<TSeriesType extends SeriesType, TData = SeriesDataItemTypeMap[TSeriesType], TOptions = SeriesOptionsMap[TSeriesType], TPartialOptions = SeriesPartialOptionsMap[TSeriesType]> {
	/**
 ...
 */
export interface PaneRendererCustomData<TData extends CustomData> {
	/**
